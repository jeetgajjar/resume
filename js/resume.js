		...
		subsections: [
			{
				...
				bullets: [
					"Client: Capital One",
					[
						"Project: Case Management June 2019 - Present",
						"Role: Tech Lead Java Engineer",
						"Create, update, maintain java microservices and own Case Management UI",
						"Microservices include Test Data management, Fraud and Dispute case management, partner card vertical (Walmart, WorldPay), SCRA",
						"Modernize legacy case system",
						"Coordinate among interdepartmental teams and report to Directors",
						"Tools: Java, AWS, Vue, Spring, Hercules, Jenkins, Postgres",
					],
